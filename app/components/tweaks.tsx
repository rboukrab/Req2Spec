...
export function useTweaks(defaults: Tweaks): [Tweaks, (key: keyof Tweaks, value: any) => void] {
...
export function TweakRadio({ label, value, options, onChange }: { label: string; value: string; options: Array<{ value: string; label: string } | string>; onChange: (v: string) => void }) {
  ...
  const opts = options.map((o) => (typeof o === "object" ? o : { value: o, label: o })) as Array<{ value: string; label: string }>;
...
export function TweakSelect({ label, value, options, onChange }: { label: string; value: string; options: Array<{ value: string; label: string } | string>; onChange: (v: string) => void }) {
  return (
    <TweakRow label={label}>
